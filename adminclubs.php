    ...
    <div class="container">
      <div class=" row">
        <div class="col-lg-8 mx-auto">
          <h1 class="text-white mb-4">Clubs</h1>
          <p class="text-white-50">Lanier High School offers a variety of clubs for artists, whether for hobby or talent.</p>
        </div>
      </div>
          ...
          <div class="bg-black text-center h-100 project">
            <div class="d-flex h-100">
              <div class="project-text w-100 my-auto text-center text-lg-right">
                <h4 class="text-white">Art Club</h4>
                <p class="mb-0 text-white-50">Art club is an entertaining club for students who enjoy art as a hobby. There are supplies for painting, drawing and more. Any student is welcome to join!</p>
          ...
          <div class="bg-black text-center h-100 project">
            <div class="d-flex h-100">
              <div class="project-text w-100 my-auto text-center text-lg-left">
                <h4 class="text-white">National Art Honors Society</h4>
                <p class="mb-0 text-white-50">The National Art Honors Society is a club for students who enjoy doing art but also are very talented in the field of art. (More info here)</p>
